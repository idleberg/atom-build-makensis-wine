...
function spawnPromise(cmd, args, opts) {
  return new Promise(function (resolve, reject) {
    Object.assign(opts, {});
    const child = Object(child_process__WEBPACK_IMPORTED_MODULE_4__["spawn"])(cmd, args, opts);
    let stdOut;
    let stdErr;
