...
/* harmony import */ var child_process__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(15);
...
/* harmony import */ var _package_json__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(16);
var _package_json__WEBPACK_IMPORTED_MODULE_5___namespace = /*#__PURE__*/__webpack_require__.t(16, 1);
'use babel';
...
const pathToScript = Object(path__WEBPACK_IMPORTED_MODULE_2__["join"])(__dirname, 'makensis-wine.sh');
console.log(pathToScript); // Package settings
...
function satisfyDependencies() {
  Object(atom_package_deps__WEBPACK_IMPORTED_MODULE_1__["install"])(_package_json__WEBPACK_IMPORTED_MODULE_5__.name);
  const packageDeps = _package_json__WEBPACK_IMPORTED_MODULE_5__['package-deps'];
...
function spawnPromise(cmd, args) {
  return new Promise(function (resolve, reject) {
    const child = Object(child_process__WEBPACK_IMPORTED_MODULE_4__["spawn"])(cmd, args);
    let stdOut;
    let stdErr;
...
function provideBuilder() {
  return class MakensisWineProvider extends events__WEBPACK_IMPORTED_MODULE_0__["EventEmitter"] {
    constructor(cwd) {
      super();
      this.cwd = cwd;
    ...
    async isEligible() {
      if (atom.config.get(`${_package_json__WEBPACK_IMPORTED_MODULE_5__.name}.alwaysEligible`) === true) {
        return true;
      }

      if (Object(os__WEBPACK_IMPORTED_MODULE_3__["platform"])() === 'win32') {
        return false;
      }
    ...
    settings() {
      ...
      const customArguments = atom.config.get(`${_package_json__WEBPACK_IMPORTED_MODULE_5__.name}.customArguments`).trim().split(' '); // Adjust errorMatch and warningMatch
...
function activate() {
  if (atom.config.get(`${_package_json__WEBPACK_IMPORTED_MODULE_5__.name}.manageDependencies`) === true) {
    satisfyDependencies();
  }
}
...
module.exports = {"name":"build-makensis-wine","version":"0.17.6","description":"Atom Build provider for makensis on Wine, compiles NSIS","repository":"https://github.com/idleberg/atom-build-makensis-wine","license":"MIT OR GPL-2.0","scripts":{"build":"webpack --mode none","dev":"webpack --mode none --watch","lint":"eslint ./src","test":"npm run lint"},"keywords":["buildprovider","compile","nsis","wine","makensis","linux","installer","build tool","compiler","linter","lint"],"main":"lib/provider.js","engines":{"atom":">=1.0.0 <2.0.0"},"providedServices":{"builder":{"description":"Compiles NSIS scripts on Wine","versions":{"2.0.0":"provideBuilder"}}},"package-deps":["build"],"dependencies":{"atom-package-deps":"^5.1.0"},"devDependencies":{"@babel/core":"^7.4.5","babel-eslint":"^10.0.2","babel-loader":"^8.0.6","copy-webpack-plugin":"^5.0.3","eslint":"^6.0.0","eslint-config-atom-build":"^4.0.0","husky":"^2.4.1","webpack":"^4.35.0","webpack-cli":"^3.3.5"},"husky":{"hooks":{"pre-commit":"npm run lint"}}};
